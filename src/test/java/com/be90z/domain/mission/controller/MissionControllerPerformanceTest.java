...
@ActiveProfiles("test")
@Transactional
@DisplayName("MissionController 성능 테스트")
class MissionControllerPerformanceTest {
    ...
    void setUp() {
        ...
        testChallenge = Challenge.builder()
                .challengeName("성능 테스트 챌린지")
                .challengeDescription("성능 측정을 위한 챌린지")
        ...
        testMission = Mission.builder()
                ...
                .missionName("성능 테스트 미션")
                .missionContent("성능 측정을 위한 테스트 미션")
    ...
    @Test
    @WithMockUser
    @DisplayName("미션 목록 조회 API 응답 시간 - 200ms 이하 검증")
    void getActiveMissions_ResponseTime_ShouldBeLessThan200ms() throws Exception {
        // given
        ...
        for (int i = 0; i < testIterations; i++) {
            ...
            MvcResult result = mockMvc.perform(get("/api/mission/list")
        ...
        System.out.println("=== 미션 목록 조회 성능 테스트 결과 ===");
    ...
    @Test
    @WithMockUser
    @DisplayName("연속 미션 목록 조회 테스트 - 5개 요청 순차 처리")
    void getActiveMissions_SequentialRequests_ShouldHandleWell() throws Exception {
        // given
        ...
        System.out.println("=== 연속 미션 목록 조회 테스트 결과 ===");
