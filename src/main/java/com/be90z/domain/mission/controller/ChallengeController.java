...
import com.be90z.domain.mission.service.ChallengeService;
...
@Tag(name = "Challenge", description = "챌린지 현황 관련 API")
public class ChallengeController {

    private final ChallengeService challengeService;

    @GetMapping("/status/{userId}")
    @Operation(summary = "사용자 챌린지 현황 조회", description = "사용자의 챌린지 현황을 조회합니다.")
    @ApiResponses(value = {
